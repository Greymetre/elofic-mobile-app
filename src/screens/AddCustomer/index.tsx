...
const AddCustomer = ({ navigation, route }: any) => {
  ...
  const loadUserList = async () => {
    try {
      ...
      const response = await fetch(
        `${BASE_URL}api/tour/userlist?supervisor=true`,
        {
          method: 'GET',
          headers: {
            Accept: 'application/json',
